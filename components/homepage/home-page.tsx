...
export default function Home({ locale }: { locale: HomepageLocale }) {
  ...
  const localePath = locale === "it" ? "/it/" : locale === "es" ? "/es/" : locale === "fr" ? "/fr/" : "/";
  useEffect(() => {
