...
const baseHomepageCopy: Record<Exclude<HomepageLocale, "es" | "fr" | "de" | "pt-BR" | "nl-NL">, HomepageCopy> = {
  en: {
    ...
    footer: { featuredOn: "Featured on", aria: "Legal information", privacy: "Privacy Policy", cookies: "Cookie Policy", manage: "Manage privacy preferences", privacyHref: "/privacy-policy/", cookiesHref: "/cookie-policy/" },
  },
  it: {
    ...
    footer: { featuredOn: "Parlano di noi", aria: "Informazioni legali", privacy: "Informativa privacy", cookies: "Informativa sui cookie", manage: "Gestisci preferenze", privacyHref: "/it/privacy-policy/", cookiesHref: "/it/cookie-policy/" },
  },
};
...
const spanishHomepageCopy: HomepageCopy = {
  ...
  footer: { featuredOn: "Han hablado de nosotros",
...
const frenchHomepageCopy: HomepageCopy = {
  ...
  footer: { featuredOn: "Ils parlent de nous",
...
const brazilianPortugueseHomepageCopy: HomepageCopy = {
  ...
  footer: { featuredOn: "Na mídia", aria: "Informações legais", privacy: "Política de Privacidade", cookies: "Política de Cookies", manage: "Gerenciar preferências de privacidade", privacyHref: "/pt-br/privacy-policy/", cookiesHref: "/pt-br/cookie-policy/" },
};
