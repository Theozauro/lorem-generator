...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/es/privacy-policy/", languages: { en: "/privacy-policy/", it: "/it/privacy-policy/", es: "/es/privacy-policy/", fr: "/fr/privacy-policy/", de: "/de/privacy-policy/" } },
  openGraph: {
    type: "website",
